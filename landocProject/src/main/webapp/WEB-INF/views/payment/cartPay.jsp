		   ...
		   <!--왼쪽영역-->
		       <div id="leftArea">
		           ...
		           <c:forEach var="cart" items="${cart }" varStatus="status">
		               <tr>
		                   <td class="pThumbnail">
		                       <img src="/projectFiles/${cart.renameFile }" id="productImg">
		                   </td>
		                   <td class="pName">
		                      ${cart.pdName }
		                   </td>
		                   ...
		                   <td class="totalPrice price">
		                      = ${cart.originPrice * cart.cartCount}
		                   </td>
		               </tr>
		               ...
		               <div id="orderInfo2">
		                   ...
		                   <table id="orderInfoTb">
		                       <tr>
		                           ...
		                           <td class="secondTd"><input type="text" value="${loginClient4.userName }" class="secondTdBox" id="userName" readonly></td>
		                       </tr>
		                       <tr>
		                           <td class="firstTd">연락처</td>
		                           <td class="secondTd"><input type="text" value="${loginClient4.phone }" class="secondTdBox" id="phone" readonly></td>
		                       </tr>
		                       <tr>
		                           <td class="firstTd">이메일</td>
		                           <td class="secondTd"><input type="text" value="${loginClient4.email }" class="secondTdBox" id="email" readonly></td>
		                       </tr>
		                       <tr>
		                           <td class="firstTd">우편번호</td>
		                           <td class="secondTd"><input type="text" value="${loginClient4.post }" class="secondTdBox" id="post" readonly></td>
		                       </tr>
		                       <tr>
		                           <td class="firstTd" rowspan="2" id="detailAddress">
		                               상세주소
		                           </td>
		                           <td><input type="text" value="${loginClient4.address }" class="secondTdBox" id="address1" readonly></td>
		                       </tr>
		                       <tr>
		                           <td><input type="text" value="${loginClient4.address }" class="secondTdBox" id="address2" readonly></td>
		                           <td></td>
		                       </tr>
		                        <tr>
		           ...
		           <div id="payInfo">
		               <table id="payInfoTb">
		                   ...
		                   <tr>
		                       ...
		                       <td class="paySecondTd price" style="color: #999;">${allDiscount }원</td>
		                   </tr>
		                   <tr>
		                       ...
		                       <span id="point">${loginClient4.point }</span></td>
		                   </tr>
		                   <tr>
		                       <td class="payFirstTd" style="color: #999;">총 할인된 금액</td>
		                       <td class="paySecondTd price" style="color: #999;" id="salesPrice">${allDiscount }원</td>
		                   </tr>
		                   <tr>
	            ...
	            <div id="orderInfo">
	                <div id="orderInfo2">
	                    ...
	                    <table id="orderInfoTb">
	                        <tr>
	                            <td class="firstTd">주문자명</td>
	                            <td class="secondTd"><input type="text" value="${loginDrClient4.userName }" class="secondTdBox" readonly></td>
	                        </tr>
	                        <tr>
	                            <td class="firstTd">연락처</td>
	                            <td class="secondTd"><input type="text" value="${loginDrClient4.phone }" class="secondTdBox" readonly></td>
	                        </tr>
	                        <tr>
	                            <td class="firstTd">이메일</td>
	                            <td class="secondTd"><input type="text" value="${loginDrClient4.email }" class="secondTdBox" readonly></td>
	                        </tr>
	                        <tr>
	                            <td class="firstTd">우편번호</td>
	                            <td class="secondTd"><input type="text" value="${loginDrClient4.post }" class="secondTdBox" readonly></td>
	                        </tr>
	                        <tr>
	                            <td class="firstTd" rowspan="2" id="detailAddress">
	                                상세주소
	                            </td>
	                            <td><input type="text" value="${loginDrClient4.address }" class="secondTdBox" id="address3" readonly></td>
	                        </tr>
	                        <tr>
	                            <td><input type="text" value="${loginDrClient4.address }" class="secondTdBox" id="address4" readonly></td>
	                            <td></td>
	                        </tr>
	                         <tr>
	                            <td class="firstTd">남기실 말</td>
	            ...
	            <div id="payInfo">
	                <table id="payInfoTb">
	                    ...
	                    <tr>
	                        ...
	                        <span>보유포인트</span></td>
	                        <td class="paySecondTd" style="color: #999;"><input class="price" type="text" id="minusPoint" name="usePoint" value=0><br>
	                        <span id="point">${loginDrClient4.point }</span></td>
	                    </tr>
	                    <tr>
	                        <td class="payFirstTd" style="color: #999;">총 할인된 금액</td>
	                        <td class="paySecondTd price" style="color: #999;" id="salesPrice">${allDiscount }원</td>
