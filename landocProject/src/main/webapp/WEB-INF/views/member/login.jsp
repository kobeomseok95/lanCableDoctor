   ...
   <div class="limiter" id="login">
      <div class="container-login100">
         <div class="wrap-login100">
            <form class="login100-form validate-form" action="memberLogin.do"
               method="post">
               ...
               </span> <span class="login100-form-title p-b-26"> 로그인 </span>
               <div class="radiobtn">
                  <label><input type="radio" id="member" name="check"
                     value="client" checked>일반회원</label> <label><input
                     type="radio" id="doctor" name="check" value="drClient"
               ...
               <div class="text-center p-t-115" id="ask">
                  <span class="txt1"> 아직 회원이 아니라구요? </span> <a class="txt2"
                     href="join.do"> 회원가입 </a> <br> <span class="txt1">
