		...
		<form id="createProduct" action="#" method="post">
			<table id="contentTb">
				...
				<tr>
					...
					<td><input type="number" name="productQunatity" /></td>
				</tr>
				<tr>
					<th class="firstLine">상품 부연 설명</th>
					<td><input type="text" name="productExplain" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="number" name="productCapacity1"
				...
				<tr>
					...
					<td><input type="text" name="productHowToEat" /></td>
				</tr>
				<tr>
					<th class="firstLine">썸네일 이미지</th>
					<td><input type="file" name="productThumbnail" /></td>
				</tr>
				<tr>
					<th class="firstLine">상세 설명 이미지</th>
					<td><input type="file" name="productDetailImage" /></td>
				</tr>
			</table>
