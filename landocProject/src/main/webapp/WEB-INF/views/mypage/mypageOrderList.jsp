                            ...
                            <tr class="color49" style="font-size:14px; color: rgba(0, 0, 0, 0.651);">
                                <td class="actions" colspan="2" style="border-bottom: solid 1px; color: lightgray; padding-top: 5px; padding-bottom: 5px;">
                                    ...
                                    <div class="links">
                                      ...
                                      <button type="button" onclick="location.href='${orderQnaInsert}'" id="edit_profile" class="btn btn-blackcontent w-10 p-1" style="font-size:13px; background-color: #0071ce; color: whitesmoke; float: left;">판매자에게 문의하기</button>
                                    </div>
                                    ...
                                    <c:if test="${o.oCode ge 1 && o.oCode le 3}">
                                     ...
                                     <c:if test="${o.oCode ge 4 && o.oCode le 5}">
                                        ...
                                        <button type="button" onclick="location.href='${pdReviewInset}'" id="edit_profile" class="btn btn-blackcontent w-10 p-1" style="font-size:13px; background-color: #0071ce; color: whitesmoke">구매후기</button>
                                     </c:if>
                                     <c:if test="${o.oCode eq 14 }">
                                     	<button type="button" id="edit_profile" class="btn btn-blackcontent w-10 p-1" style="font-size:13px; background-color: #0071ce; color: whitesmoke">리뷰수정</button>
                                     </c:if>
                                    </div>
                                </td>
                            </tr>
    ...
    <!--paginnation start-->
            <nav aria-label="Page navigation">
                ...
                <c:url var="blistBack" value="myOrderList.do">
                    ...
                    <li style="width: 30px;">
	                <a href="blistBack" aria-label="Previous">
	                <span aria-hidden="true">«</span>
	                </a>
	                </li>
                </c:if>
                ...
                <c:if test="${p eq pi.currentPage }">
                  <li class="active" style="width: 30px; color:black;"><a href="#">${p}</a></li>
                </c:if>
                ...
                <c:if test="${pi.currentPage lt pi.maxPage }">
                    ...
                    <li style="width: 30px;">
	                <a href="blistNext" aria-label="Previous">
	                <span aria-hidden="true">»</span>
	                </a>
	                </li>
                </c:if>
