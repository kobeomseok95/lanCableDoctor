	...
	<div class="container" style="margin-top: 80px;text-align: center">
        <div class="p-4" style="width: 1000px; display: inline-block;">
			...
			<div class="review-list-title text-left" style="font-size: 40px;">
				<a href="mypageWork.html" style="color: #0071ce;letter-spacing: -0.5px;">
                    나의 QnA 문의글
                </a>
                >
                ...
                <div class="card mt-3 mb-3 text-left">
                    ...
                    <div class="card-header newreview p-4" data-toggle="collapse" data-target="#collapse-${y.oqnaNo}" href="#collapse-${y.oqnaNo}" aria-expanded="false" aria-controls="collapse-${y.oqnaNo}" style="cursor: pointer;">
                    ...
                    <div id="collapse-${y.oqnaNo}" class="card-body collapse p-4">
                        <div class="color49 mb-4" style="font-weight: bold">
                            ...
                            <div class="mr-2">상품명 :</div>
                              <div class="rounded-pill p-2 ml-1 mr-1" style="background-color: #e9e9e9;"><a href="#" style="color: #45668e;">${y.pdName}</a></div>
                            </div>
                        </div>
                        <div class="row">
...
<!--paginnation start-->
            <nav aria-label="Page navigation">
                ...
                <c:if test="${p eq pi.currentPage }">
                  <li class="active" style="width: 30px;"><a href="#" style="color:#a82400;">${p}</a></li>
                </c:if>
