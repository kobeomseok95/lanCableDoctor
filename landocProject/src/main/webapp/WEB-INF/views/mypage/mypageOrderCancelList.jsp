            ...
            <div class="row px-3 py-5" id="posit">
                ...
                <div class="col-12 text-left">
                    ...
                    <div class="point-breadcrumb text-left">
                        ...
                        >
                        <strong class="ml-2" style="font-size: 25px;">주문취소/교환/반품 목록</strong>
                    </div>
                    ...
                    <table  class="table w-100 border-bottom" style=" margin-bottom: 30px; margin-top: 40px;">
                        <thead >
                       ...
                       <tbody>
                             <tr  class="color49" style="font-size:14px; color: rgba(0, 0, 0, 0.651);">
                                ...
                                <td class="product" style="border-right: solid 1px; border-color: lightgray; border-bottom: solid 1px; border-color: lightgray; vertical-align:middle;" rowspan="2">
                                ...
                                <td class="status" style="vertical-align:middle; text-align: center; border-bottom: solid 1px; border-color: lightgray; vertical-align:middle;" rowspan="2">
