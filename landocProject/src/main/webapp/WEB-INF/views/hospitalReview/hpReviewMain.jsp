    ...
    <!-- ************************************************************************************************************************************ -->
            ...
            <div class="row p-3">
                <div class="col-20 w-100" id="left-fixed">
                   ...
                   <input type="hidden" id="addr" value="${hp.hpAddress}">
					<div id="map" style="width:100%;height:300px;"></div>
					<!-- <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=e0d7fba272c0e3f0fc208aad65ce2f31"></script> -->
					<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=e0d7fba272c0e3f0fc208aad65ce2f31&libraries=services"></script>
					<script>
						
						var addr = $("#addr").val();
						var hpName = '<c:out value="${hp.hpName}"/>'
						    ...
						    // 정상적으로 검색이 완료됐으면 
						     if (status === kakao.maps.services.Status.OK) {
						        ...
						        var infowindow = new kakao.maps.InfoWindow({
						            content: '<div style="width:150px;text-align:center;padding:6px 0;">'+hpName+'</div>'
						        });
