...
public class AdminHpReview implements Serializable{
   ...
   public AdminHpReview(int rowNum, int hpNo, String hpName, int hpCateNo, String hpCateName, String cNo, String cId,
		String approval, int hpReNo, String hpReContent, String like, double avgRate, double explanation,
		double kindness, double waitingTime, double trResult, double sanitary, double price, double count,
		Date writeDate, String originFile, String renameFile, String filePath) {
	this.rowNum = rowNum;
...
public String toString() {
	return "AdminHpReview [rowNum=" + rowNum + ", hpNo=" + hpNo + ", hpName=" + hpName + ", hpCateNo=" + hpCateNo
			+ ", hpCateName=" + hpCateName + ", cNo=" + cNo + ", cId=" + cId + ", approval=" + approval + ", hpReNo="
			+ hpReNo + ", hpReContent=" + hpReContent + ", like=" + like + ", avgRate=" + avgRate + ", explanation="
