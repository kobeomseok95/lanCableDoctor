...
public class HpSearch {
	...
	// 병원이름 한글자씩 뽑아내기 위한 값
	private ArrayList<HpNameSplit> hpNameSplit;	
	...
	public HpSearch(int hpNo, String hpName, String hpPhone, String hpPostcode, String hpAddress, String hpX,
			...
			String proFilepath, String cateName, String area, ArrayList<HpNameSplit> hpNameSplit) {
		super();
		this.hpNo = hpNo;
		this.hpName = hpName;
	...
	public ArrayList<HpNameSplit> getHpNameSplit() {
		return hpNameSplit;
	}

	public void setHpNameSplit(ArrayList<HpNameSplit> hpNameSplit) {
		this.hpNameSplit = hpNameSplit;
	}
