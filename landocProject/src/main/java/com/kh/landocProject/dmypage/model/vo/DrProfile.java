...
public class DrProfile implements Serializable{
	...
	public DrProfile(String drNo, String drName, int hpNo, String hpName, int hpCateCode, String hpCateName,
			...
			double choosePer, int drCommentNo, Date drCommentDate, String drComment) {
		this.drNo = drNo;
		this.drName = drName;
		this.hpNo = hpNo;
		this.hpName = hpName;
	...
	public String toString() {
		return "DrProfile [drNo=" + drNo + ", drName=" + drName + ", hpNo=" + hpNo + ", hpName=" + hpName
				...
				+ ", chooseStatus=" + chooseStatus + ", choosePer=" + choosePer + ", drCommentNo=" + drCommentNo
				+ ", drCommentDate=" + drCommentDate + ", drComment=" + drComment + "]";
	}
