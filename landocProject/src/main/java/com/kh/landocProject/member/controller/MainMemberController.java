...
//						System.out.println(DrClientsearchPwd);
		...
		@RequestMapping(value="searchPwd2.do")
		public ModelAndView searchPwd2(Client c, DrClient d, HttpServletRequest request, 
								String cNo, String drNo, String email,
			...
			if(drNo == null && cNo != null) {
				String setfrom = "rornfl258@naver.com";								// 보내는 사람
				String tomail = email;			// 받는 사람 이메일
				String title = "읍남매들 비밀번호 인증 이메일 입니다.";				// 제목
				String content =  System.getProperty("line.separator")+ //한줄씩 줄간격을 두기위해 작성
				 ...
				 try {
					...
					mv.setViewName("member/searchPwd3");
					mv.addObject("dice", dice);
					mv.addObject("cNo", cNo);
					
					System.out.println("mvewew : " + mv);
					
					response_email.setContentType("text/html; charset=UTF-8");
					PrintWriter out_email = response_email.getWriter();
					out_email.println("<script>alert('메일이 발송되었습니다. 인증번호를 입력해주세요.');</script>");
					out_email.flush();
					        
					return mv;
			}else if(drNo != null && cNo == null) {
				String setfrom = "rornfl258@naver.com";								// 보내는 사람
				String tomail = email;			// 받는 사람 이메일
				String title = "읍남매들 비밀번호 인증 이메일 입니다.";				// 제목
				String content =  System.getProperty("line.separator")+ //한줄씩 줄간격을 두기위해 작성
		...
		@RequestMapping(value="searchPwd3.do")
		public ModelAndView searchPwd3(String message, String dice, String drNo, String cNo,
											HttpServletResponse response_equals, ModelAndView mv, ModelAndView mv2) throws IOException{
			System.out.println("mainMemberController.java test line 657");
			System.out.println("마지막 : message : " + message);
			System.out.println("마지막 : dice : " + dice);
//			System.out.println("email : " + email);
...
//				mv.addObject("joinDrClient2", joinDrClient2);
				...
				mv2.setViewName("member/searchPwd4");
