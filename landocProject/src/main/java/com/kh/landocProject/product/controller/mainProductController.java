...
public class mainProductController {
	...
	public ModelAndView productIndex(ModelAndView mv, @RequestParam int sortNo, @RequestParam int pageNo,
	...
	public ModelAndView productSearch(ModelAndView mv, @RequestParam String keyword,
			@RequestParam(required = false) Integer sortNo, @RequestParam(required = false) Integer pageNo) {
	...
	public ModelAndView productDetail(ModelAndView mv, @RequestParam int pdNo, String msg) {
	...
	public HashMap<String, Object> getAsyncRecommends(@RequestParam int pdNo, @RequestParam int pageNo) {
		int recommendCount = productServiceImpl.getRecommendCount(pdNo);
	...
	public HashMap<String, Object> getAsyncReviews(@RequestParam int pdNo, @RequestParam int pageNo) {
		int reviewCount = productServiceImpl.getReviewCount(pdNo);
	...
	public HashMap<String, Object> getAsyncQnas(@RequestParam int pdNo, @RequestParam int pageNo) {
		int qnaCount = productServiceImpl.getQnaCount(pdNo);
	...
	public HashMap<String, Object> getpdqAnswer(@RequestParam int pdqNo, @RequestParam String pdqPwd) {
	...
	public ModelAndView recommand(ModelAndView mv, @RequestParam("drNo") List<String> drNo, @RequestParam("drNo") String drNo1,
		...
		for (int i = 0; i < pdNo.size(); i++) {
			reco = new HashMap<String, Object>();
